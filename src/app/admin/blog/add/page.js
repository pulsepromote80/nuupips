...
//   // Handle canonical change with debounce
//   const handleCanonicalChange = useCallback((e) => {
...
//       const formattedValue = formatCanonical(value);
...
//       try {
//         // Final canonical formatting before submit
//         const formattedCanonical = formatCanonical(values.canonical || values.title);
        
//         const statusValue = values.status === '1' ? 1 : 0;
...
//           Canonical: formattedCanonical, // Formatted canonical bhejo
...
//   //  useEffect(() => {
//   //   // Agar canonical field empty hai aur title hai to auto-generate karo
//   //   if (formik.values.title && !formik.values.canonical) {
//   //     const generatedCanonical = formatCanonical(formik.values.title);
//   //     formik.setFieldValue('canonical', generatedCanonical);
//   //   }
//   // }, [formik.values.title]); 
...
const AddBlogPage = () => {
  ...
  // ✅ Auto-generate from title (optional)
  useEffect(() => {
    if (formik.values.title && !formik.values.canonical) {
      const generatedCanonical = formatCanonical(formik.values.title);
      formik.setFieldValue('canonical', generatedCanonical);
                ...
                <div className='pt-2'>
                  ...
                  <input
                    ...
                    onBlur={(e) => {
                      ...
                      const formattedValue = formatCanonical(e.target.value);
                      formik.setFieldValue('canonical', formattedValue);
                    }}
