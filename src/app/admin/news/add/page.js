          ...
          <div className="space-y-6">
              ...
              {!thumbnailPreview ? (
                <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-[#29d2cc] transition-colors">
                  ...
                  <label
                    ...
                    className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#29d2cc] text-white text-sm font-medium rounded-lg hover:bg-[#c05545] transition-colors cursor-pointer"
                  >
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full px-4 py-3 bg-[#29d2cc] text-white font-medium rounded-lg hover:bg-[#c05545] hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
