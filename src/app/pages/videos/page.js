...
// // import {getCourseCategory,getActiveCourse} from "@/app/redux/slices/courseCategorySlice"

// // const Section5 = () => {
// //   const dispatch = useDispatch();
// //   const loading = useSelector((state) => state.courseCategory.loading);
// //   const categories = useSelector((state) => state.courseCategory.data);
...
// //   // Process categories from API - filter active categories with valid names
...
// //         item.courseCategoryName.trim() !== ""
// //       )
// //       .map(item => item.courseCategoryName)
// //   ];

// //   console.log("Processed Categories:", processedCategories);

// //   const videoData = [
// //     // ... (your existing videoData remains the same)
// //     {
// //       id: 1,
...
//   const loading = useSelector((state) => state.courseCategory.loading);
//   const categories = useSelector((state) => state.courseCategory.data);
//   const activeCourseData = useSelector((state) => state.courseCategory.CourseData);
...
//   // Find the category ID when name is clicked
//   const getCategoryIdByName = (categoryName) => {
//     if (categoryName === "All Videos") return null;
    
//     const category = (categories || []).find(
//       item => item.courseCategoryName === categoryName && item.status === "Active"
//     );
//     return category?.courseCategoryId || null;
//   };
...
//     console.log("UUU",categoryId)
    
//     if (categoryId) {
//         setIsLoadingVideos(true);
//         try {
//             const result = await dispatch(getActiveCourse(categoryId)).unwrap();
//             console.log("Active course data:", result);
            
//             // Transform API response to match videoData format
//             if (result?.data && Array.isArray(result.data)) {
//               console.log("OOO",result.data);
//                 const transformedVideos = result.data.map((item, index) => ({
//                     id: item.courseId || `api-${index}`,
//                     title: item.tittle || "Untitled Video",
//                     description: item.description || "",
//                     category: item.courseCategoryName || category,
//                     duration: item.duration || "N/A",
//                     timeAgo: getTimeAgo(item.createdDate),
//                     rating: item.rating || 0,
//                     reviews: item.noOfRating || 0,
//                     imgSrc: item.thumbnailImage || "/assets/img/videos/default.jpg",
//                     bgClass: getBgClassByCategory(item.courseCategoryName),
//                     videoUrl: item.courseVideo || "#"
//                 }));
//                 setCategoryVideos(transformedVideos);
//             } else {
//                 setCategoryVideos([]);
//             }
//         } catch (error) {
...
//         }
//     } else {
//         // If "All Videos" is selected or no category ID found, clear category videos
//         setCategoryVideos([]);
//     }
// };
...
//   // Helper function to get background class based on category
//   const getBgClassByCategory = (categoryName) => {
//     const categoryMap = {
//       'bac': 'edu-bg-primary-soft',
//       'Himanchal': 'edu-bg-info-soft',
//       'Forex Education': 'edu-bg-info-soft',
//       'Stock Market': 'edu-bg-success-soft',
//       'Technical Analysis': 'edu-bg-danger-soft',
//       'Risk Management': 'edu-bg-warning-soft',
//       'Psychology': 'edu-bg-purple-soft'
//     };
    
//     return categoryMap[categoryName] || 'edu-bg-primary-soft';
//   };

//   // Static video data remains the same
...
//   const displayedVideos = activeCategory === "All Videos" 
//     ? staticVideoData 
//     : (categoryVideos.length > 0 ? categoryVideos : staticVideoData.filter(video => video.category === activeCategory));
...
//               <div className="edu-popup-details">
//                 <div className="edu-popup-header">
//                   <span className={`edu-category-badge edu-badge-${selectedVideo.bgClass?.split('-')[2] || 'primary'}`}>
//                     {selectedVideo.category}
//                   </span>
//                   <span className="edu-popup-duration">
//                     <FaRegClock /> {selectedVideo.duration}
...
//                   <div className="edu-stars">
//                     {[...Array(5)].map((_, i) => (
//                       <FaStar key={i} className={i < Math.floor(selectedVideo.rating) ? 'edu-star-filled' : 'edu-star-empty'} />
//                     ))}
//                   </div>
//                   <span className="edu-rating-value">{selectedVideo.rating}</span>
//                   <span className="edu-reviews-count">({selectedVideo.reviews} reviews)</span>
...
//           {isLoadingVideos && (
//             <div className="edu-loading-spinner">
//               <FaSpinner className="edu-spinner-icon" />
...
//                 style={{ cursor: "pointer" }}
//               >
//                 <div className={`edu-video-thumbnail ${video.bgClass || 'edu-bg-primary-soft'}`}>
//                   <div className="edu-thumbnail-image">
//                     {video.imgSrc?.startsWith('http') ? (
//                       <img
//                         src={video.imgSrc}
//                         alt={video.title}
//                         className="edu-thumbnail-img"
...
//                 <div className="edu-video-body">
//                   <div className="edu-video-meta">
//                     <span className={`edu-category-badge edu-badge-${video.bgClass?.split('-')[2] || 'primary'}`}>
//                       {video.category}
//                     </span>
//                     <span className="edu-time-ago">
//                       <FaClock className="edu-time-icon" />
...
//                       <div className="edu-stars">
//                         {[...Array(5)].map((_, i) => (
//                           <FaStar key={i} className={i < Math.floor(video.rating) ? 'edu-star-filled' : 'edu-star-empty'} />
//                         ))}
//                       </div>
//                       <span className="edu-rating-value">{video.rating}</span>
//                       <span className="edu-reviews-count">({video.reviews} reviews)</span>
...
const Section5 = () => {
  ...
  const videoData = [
    ...
    {
      id: 7,
      title: "What is Financial Market?",
      description: "A financial market is a broad term for any marketplace where buyers and sellers trade assets such as equities, bonds, currencies, and derivatives.",
      category: "Forex Education",
      duration: "00:42",
      timeAgo: "1 week ago",
      rating: 4.8,
      reviews: 89,
      imgSrc: "/assets/img/videos/lession1.png",
      bgClass: "edu-bg-info-soft",
      videoUrl: "https://www.youtube.com/embed/yPeNMyNNL_4"
      
    },
    {
      id: 8,
      title: "What is Forex?",
      description: "Forex, short for Foreign Exchange, is the global marketplace for trading national currencies against one other.",
      category: "Forex Education",
      duration: "00:38",
      timeAgo: "1 week ago",
      rating: 4.9,
      reviews: 134,
      imgSrc: "/assets/img/videos/lession2.png",
      bgClass: "edu-bg-info-soft",
      videoUrl: "https://www.youtube.com/embed/W0xKRmcYdOQ"
    },
    {
      id: 9,
      title: "What is Stock Market?",
      description: "The stock market is a regulated marketplace where investors can buy and sell shares of publicly traded companies.",
      category: "Forex Education",
      duration: "00:26",
      timeAgo: "2 weeks ago",
      rating: 4.7,
      reviews: 156,
      imgSrc: "/assets/img/videos/lession3.png",
      bgClass: "edu-bg-info-soft",
      videoUrl: "https://www.youtube.com/embed/peUPAdfye7k"
    },
    
     {
      id: 10,
      title: "What is Risk Management?",
      description: "Risk management in Forex trading is the process of identifying, analyzing, and mitigating the potential for financial loss.",
      category: "Forex Education",
      duration: "02:24",
      timeAgo: "2 weeks ago",
      rating: 4.7,
      reviews: 156,
      imgSrc: "/assets/img/videos/lession4.png",
      bgClass: "edu-bg-info-soft",
      videoUrl: "https://www.youtube.com/embed/JlP1AtoQxkU"
    },
